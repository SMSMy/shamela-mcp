...
- **\`shamela_skill\`** — عرض مهارة الباحث المدمجة، وهي تعليماتُ البحث المنهجية الموجَّهة إلى المساعد نفسه (قواعد التضييق والتوسيع، وبروتوكول صفر النتائج، وأمانة النسبة، ودليل الأدوات)، كاملةً أو قسمًا منها: المهارة أو القواعد أو الأدوات.
  مثال: «فعِّل مهارة الباحث قبل أن نبدأ في المسألة.»
